...
@/home/student/lab9/apply_oracle_lab9.sql
...
AND t.transaction_account = cl1.common_lookup_id
...
COLUMN base_revenue FORMAT A20 HEADING "BASE_REVENUE"
COLUMN 10_plus FORMAT A20 HEADING "10_PLUS"
COLUMN 20_plus FORMAT A20 HEADING "20_PLUS"
COLUMN 10_plus_less FORMAT A20 HEADING "10_PLUS_LESS"
COLUMN 20_plus_less FORMAT A20 HEADING "20_PLUS_LESS"

-- Query, aggregate, and sort data.
-- Query for initial counts, should return:

SELECT to_char(transaction_date, 'MON-YYYY') AS month
, TO_CHAR(SUM(transaction_amount), '$9,999.00') AS "BASE_REVENUE"
, TO_CHAR(SUM(transaction_amount)*1.1, '$9,999.00') AS "10_PLUS"
, TO_CHAR(SUM(transaction_amount)*1.2, '$9,999.00') AS "20_PLUS"
, TO_CHAR(SUM(transaction_amount)*0.1, '$9,999.00') AS "10_PLUS_LESS"
, TO_CHAR(SUM(transaction_amount)*0.2, '$9,999.00') AS "20_PLUS_LESS"
FROM transaction
