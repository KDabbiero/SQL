...
@/home/student/lab8/apply_oracle_lab8.sql
...
( transaction_id            int             
, transaction_account       char(15)            CONSTRAINT nn_transaction1 NOT NULL
, transaction_type          int                 CONSTRAINT nn_transaction2 NOT NULL
, transaction_date          date                CONSTRAINT nn_transaction3 NOT NULL
, transaction_amount        number(38)          CONSTRAINT nn_transaction4 NOT NULL
, rental_id                 int                 CONSTRAINT nn_transaction5 NOT NULL
, payment_method_type       int                 CONSTRAINT nn_transaction6 NOT NULL
, payment_account_number    char(19)            CONSTRAINT nn_transaction7 NOT NULL
, created_by                int                 CONSTRAINT nn_transaction8 NOT NULL
, creation_date             date                CONSTRAINT nn_transaction9 NOT NULL
, last_updated_by           int                 CONSTRAINT nn_transaction10 NOT NULL
, last_update_date          date                CONSTRAINT nn_transaction11 NOT NULL
, CONSTRAINT pk_transaction PRIMARY KEY (transaction_id)
, CONSTRAINT fk_transaction1 FOREIGN KEY (transaction_type) REFERENCES common_lookup(common_lookup_id)
, CONSTRAINT fk_transaction2 FOREIGN KEY (rental_id) REFERENCES rental(rental_id)
, CONSTRAINT fk_transaction3 FOREIGN KEY (payment_method_type) REFERENCES common_lookup(common_lookup_id)
, CONSTRAINT fk_transaction4 FOREIGN KEY (created_by) REFERENCES system_user(system_user_id)
, CONSTRAINT fk_transaction5 FOREIGN KEY (last_updated_by) REFERENCES system_user(system_user_id)
);
...
-- ----------------------------------------------------------------------
CREATE SEQUENCE transaction_s1 START WITH 1001 NOCACHE;
...
(airport_id             int 
, airport_code          varchar2(3)             CONSTRAINT nn_airport NOT NULL
, airport_city          varchar2(30)            CONSTRAINT nn_airport1 NOT NULL
, city                  varchar2(30)            CONSTRAINT nn_airport2 NOT NULL
, state_province        varchar2(30)            CONSTRAINT nn_airport3 NOT NULL
, created_by            int                     CONSTRAINT nn_airport4 NOT NULL
, creation_date         date                    CONSTRAINT nn_airport5 NOT NULL
, last_updated_by       int                     CONSTRAINT nn_airport6 NOT NULL
, last_update_date      date                    CONSTRAINT nn_airport7 NOT NULL
, CONSTRAINT pk_airport PRIMARY KEY (airport_id)
, CONSTRAINT fk_airport1 FOREIGN KEY (created_by) REFERENCES system_user (system_user_id)
, CONSTRAINT fk_airport2 FOREIGN KEY (last_updated_by) REFERENCES system_user (system_user_id));
...
-- ----------------------------------------------------------------------
CREATE SEQUENCE airport_s1 START WITH 1001 NOCACHE;
...
(account_list_id            int                 
, account_number            varchar2(10)            CONSTRAINT nn_account_list NOT NULL
, consumed_date             date
, consumed_by               int 
, created_by                int                     CONSTRAINT nn_account_list1 NOT NULL
, creation_date             date                    CONSTRAINT nn_account_list2 NOT NULL
, last_updated_by           int                     CONSTRAINT nn_account_list3 NOT NULL
, last_update_date          date                    CONSTRAINT nn_account_list4 NOT NULL
, CONSTRAINT pk_account_list PRIMARY KEY (account_list_id)
, CONSTRAINT fk_account_list1 FOREIGN KEY (consumed_by) REFERENCES system_user(system_user_id)
, CONSTRAINT fk_account_list2 FOREIGN KEY (created_by) REFERENCES system_user(system_user_id)
, CONSTRAINT fk_account_list3 FOREIGN KEY (last_updated_by) REFERENCES system_user (system_user_id)
);
...
-- ----------------------------------------------------------------------
CREATE SEQUENCE account_list_s1 START WITH 1001 NOCACHE;
